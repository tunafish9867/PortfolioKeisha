export const skills = [
  ...
  },
  {
    ...
    image: '/skills/ai-data-processing.jpg',
    description:
      'Using AI models to read unstructured, free-text input and turn it into structured, actionable decisions inside a live workflow — like routing, classification, and content generation.',
    filterTech: ['OpenAI'],
  },
  {
    id: 'api-integrations',
