export const projects = [
  ...
  },
  {
    ...
    steps: [
      {
        anim: { variant: 'branch', nodes: ['ai', 'store', 'store', 'store', 'store','store'] },
      ...
      {
        anim: { variant: 'linear', nodes: ['email', 'clip'] },
      ...
      {
        anim: { variant: 'linear', nodes: ['clip', 'remind'] },
        title: 'Document Delivery',
        description:
          'Exports the letter to PDF, attaches it to the ClickUp task, and posts a signature-reminder comment.',
      },
      {
        anim: { variant: 'merge', nodes: ['subscenario', 'subscenario','subscenario','subscenario','subscenario', 'qb'] },
      ...
      {
        anim: { variant: 'branch', nodes: ['remind', 'renew','notrenew'] },
      ...
      {
        anim: { variant: 'linear', nodes: ['qb', 'record'] },
      ...
      {
        anim: { variant: 'branch', nodes: ['qb', 'email','notrenew'] },
  ...
  },
  {
    ...
    steps: [
      {
        anim: { variant: 'linear', nodes: ['clicking', 'sheets'] },
      ...
      {
        anim: { variant: 'linear', nodes: ['sheets', 'system'] },
  ...
  },
  {
    ...
    steps: [
      {
        anim: { variant: 'branch', nodes: ['clicking', 'store', 'store', 'store', 'store', 'store'] },
        title: 'Select Branch',
        description:
      ...
      {
        anim: { variant: 'linear', nodes: ['pencil', 'tools', 'pencil2'] },
        title: 'Add Slabs',
        description:
      ...
      {
        anim: { variant: 'linear', nodes: ['pencil', 'building', 'crane'] },
      ...
      {
        anim: { variant: 'merge', nodes: ['pencil', 'tools', 'clip'] },
      ...
      {
        anim: { variant: 'linear', nodes: ['clicking', 'clip'] },
